...
const patient_repository_1 = require("../../../src/repositories/patient.repository");
...
describe('PatientRepository', () => {
    ...
    beforeAll(async () => {
        ...
        repo = new patient_repository_1.PatientRepository(db);
    });
    afterAll(async () => {
...
//# sourceMappingURL=patient.repository.test.js.map