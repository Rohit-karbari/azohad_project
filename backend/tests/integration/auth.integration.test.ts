...
describe('Auth API Integration Tests', () => {
  ...
  describe('POST /auth/patient/register', () => {
    test('should register a new patient', async () => {
      const response = await request(app).post('/auth/patient/register').send({
    ...
    test('should fail with duplicate email', async () => {
      await request(app).post('/auth/patient/register').send({
  ...
  describe('POST /auth/patient/login', () => {
    ...
    test('should login with correct credentials', async () => {
      const response = await request(app).post('/auth/patient/login').send({
        email: 'login@example.com',
        password: 'SecurePassword123!',
      });
